...
import { BarChart3, ArrowRight, CheckCircle2, TrendingUp, Zap, Sparkles } from "lucide-react";
            ...
            <section className="w-full max-w-7xl mx-auto px-6 pt-32 pb-20 relative z-10">
                <div className="flex flex-col items-start max-w-5xl">
                    ...
                    >
                        ...
                        <span className="text-[0.65rem] font-black text-white tracking-[0.4em] uppercase">ROI Optimization</span>
                    </motion.div>
                    ...
                    >
                        Growth <br />
                        <span className="italic font-light text-slate-400">Engine.</span>
                    </motion.h1>
            ...
            <section className="w-full max-w-7xl mx-auto px-6 py-20 relative z-10">
                <div className="grid lg:grid-cols-2 gap-20">
                    <div className="space-y-12">
                        <h2 className="text-4xl font-bold text-[#111] tracking-tight">Data-Backed Growth Logic.</h2>
                    ...
                    <div className="relative">
                        <div className="sticky top-10 rounded-[3.5rem] bg-[#111] p-16 overflow-hidden h-full min-h-[500px] flex flex-col justify-between group shadow-2xl">
                             ...
                             <div className="relative z-10">
                                <BarChart3 className="w-20 h-20 text-[#F05E23] mb-12" />
                                <h3 className="text-4xl font-bold text-white mb-8 leading-tight">Mastering High- <br /> <span className="text-[#F05E23] italic font-light">Velocity Growth.</span></h3>
