...
import { BarChart3, ArrowRight, TrendingUp, ArrowUpRight, CheckCircle2 } from "lucide-react";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    <div className="lg:col-span-7 flex flex-col items-start">
                        ...
                        >
                            ...
                            <span className="text-[0.65rem] font-extrabold text-white tracking-[0.3em] uppercase">ROI Optimization</span>
                        </motion.div>
                        ...
                        >
                            Growth <span className="text-[#F05E23]">Engine.</span>
                        </motion.h1>
                        ...
                        >
                            Eliminating market guesswork through rigorous audience intelligence and surgical performance tracking. We turn attention into compounding revenue.
                        </motion.p>
                    </div>
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-4 p-6 sm:p-8 rounded-3xl border bg-white/5 backdrop-blur-md border-neutral-500/15 shadow-xl">
                        <div className="flex items-center gap-3">
                            <TrendingUp className="w-5 h-5 text-[#F05E23]" />
                            <span className="text-xs font-black uppercase tracking-widest text-[#F05E23]">Compounding Revenue</span>
                        </div>
                        <p className={`text-xs sm:text-sm font-medium ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                            Precision ad targeting, SEO dominance, conversion funnels, and real-time performance tracking.
                        </p>
                        <Link
                            href="/contact"
            ...
            <section className="w-full max-w-7xl mx-auto px-6 py-10 sm:py-14 relative z-10">
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    <div className="lg:col-span-7 space-y-8">
                        <div>
                            <h2 className={`text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight mb-3 ${isDark ? 'text-white' : 'text-[#111]'}`}>Data-Backed Growth Logic.</h2>
                            <p className={`text-base sm:text-lg leading-relaxed ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
                                Growth isn’t an accident; it’s an engineering problem. We solve it using advanced lead-intelligence and behavior-modeling.
                            </p>
                        </div>

                        <div className="grid gap-4">
                            {[
                                { title: "Surgical Ads Targeting", desc: "Precision campaigns designed for maximum conversion at minimal CPA." },
                                { title: "SEO Search Dominance", desc: "Commanding the search landscape through high-authority content ecosystems." },
                                { title: "Strategic Content Funnels", desc: "High-level creative assets engineered for user-intent and conversion." },
                                { title: "Performance Audits", desc: "Rigorous analysis of your growth leaks and scaling opportunities." }
                            ].map((item, i) => (
                    ...
                    <div className="lg:col-span-5 relative">
                        <div className="sticky top-24 rounded-3xl bg-[#111] p-8 sm:p-10 overflow-hidden flex flex-col justify-between shadow-2xl text-white min-h-[380px]">
                            ...
                            <div className="relative z-10 space-y-6">
                                <BarChart3 className="w-12 h-12 text-[#F05E23]" />
                                <h3 className="text-2xl sm:text-3xl font-extrabold leading-snug">
                                    Mastering High- <br />
                                    <span className="text-[#F05E23] italic font-light">Velocity Growth.</span>
                                </h3>
                                <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
                                    Our growth engine eliminates waste while identifying the surgical advantages of your market position.
                                </p>
                            </div>
